                    ...
                    <div style={{ backgroundColor: "#fff", paddingTop: "2rem", paddingBottom: "2rem" }}>
                        <div className="" style={{ maxWidth: "56rem", marginLeft: "auto", marginRight: "auto", textAlign: "center" }}>
                            ...
                            <div class="redes-container ">
                                <Link
                                    to="https://www.facebook.com" target='blank'
                                    class="redes-link "
                                >
                                ...
                                <Link
                                    to="https://www.youtube.com" target='blank'
                                    class="redes-link "
                                >
                                ...
                                <Link
                                    to="https://www.instagram.com" target='blank'
                                    class="redes-link "
                                >
                                ...
                                <Link
                                    to="https://www.linkedIn.com" target='blank'
                                ...
                                <Link
                                    to="https://www.twitter.com" target='blank'
                                    class="redes-link"
                                >
                                ...
                                <Link
                                    to="https://www.tiktok.com" target='blank'
                                    class="redes-link "
                                >
                    ...
                    <div class='follow'>
                        ...
                        <div class="card-follow">
                            ...
                            <div class="card__img-follow">
                                ...
                                <img style={{ borderRadius: "8px", border: "2px solid #000", objectFit: "cover", width: "100%", height: "100%" }} src="https://wadmin.uca.edu.ar/public/filters/medium/public/20241025/1729873664_placa.jpg" alt="" />
                            </div>
                            <div class="card-int-follow">
                                {/* <p class="card-int__title-follow">This is the article title</p> */}
                                <div style={{ border: "2px solid #000", display: "flex", justifyContent: "center" }}>
                                    <img style={{ border: "2px solid #456" }} src="https://uca.edu.ar/assets/img/instagram3.jpg" alt="" />
                                </div>
                                <p class="excerpt-follow">The San Diego UC School, at its Congress headquarters, paid tribute to three important figures in its history, in an act full of symbolism...</p>
                        ...
                        <div class="card-follow">
                            ...
                            <div class="card__img-follow">
                                {/* <span class="card__span-follow">Category</span> */}
                                <img style={{ borderRadius: "8px", border: "2px solid #000", objectFit: "cover", width: "100%", height: "100%" }} 
                                
                                src="https://wadmin.uca.edu.ar/public/filters/medium/public/20241025/1729873617_filo.jpg" alt="" />
                            </div>
                            <div class="card-int-follow">
                                {/* <p class="card-int__title-follow">This is the article title</p> */}
                                <div style={{ border: "2px solid #000", display: "flex", justifyContent: "center" }}>
                                    <img style={{ border: "2px solid #456" }} src="https://uca.edu.ar/assets/img/facebook3.jpg" alt="" />
                                </div>
                                <p class="excerpt-follow">The Faculty of Philosophy and Letters of the UC presented the bibliographic collection of Philosophy, Letters and Languages, composed of three ...</p>
                        ...
                        <div class="card-follow">
                            ...
                            <div class="card__img-follow">
                                {/* <span class="card__span-follow">Category</span> */}
                                <img style={{ borderRadius: "8px", border: "2px solid #000", objectFit: "cover", width: "100%", height: "100%" }} 
                                src="https://wadmin.uca.edu.ar/public/filters/medium/public/20230126/1674764857_10%20an%CC%83os%20de%20compromiso%20social%20en%20la%20UCA%20(3).jpg" alt="" />
                            </div>
                            <div class="card-int-follow">
                                {/* <p class="card-int__title-follow">This is the article title</p> */}
                                <div style={{ border: "2px solid #000", display: "flex", justifyContent: "center" }}>
                                    <img style={{ border: "2px solid #456" }} src="https://uca.edu.ar/assets/img/X.png" alt="" />
                                </div>
                                <p class="excerpt-follow">The UC Emergency Brigade, created at the initiative of the Operational Services Directorate and intended to address extreme situations..</p>
